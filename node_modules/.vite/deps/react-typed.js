      ...
      return function(e2) {
          ...
          return function(e3) {
            ...
            var o = n2(1), s = n2(3), i = function() {
              ...
              return r2(e4, [{ key: "toggle", value: function() {
                ...
                } else this.setPauseStatus(e5, t3, true);
            ...
            var s, i = n2(2), a = (s = i) && s.__esModule ? s : { default: s }, u = function() {
              ...
              return o(e4, [{ key: "load", value: function(e5, t3, n3) {
                if (e5.el = "string" == typeof n3 ? document.querySelector(n3) : n3, e5.options = r2({}, a.default, t3), e5.isInput = "input" === e5.el.tagName.toLowerCase(), e5.attr = e5.options.attr, e5.bindInputFocusEvents = e5.options.bindInputFocusEvents, e5.showCursor = !e5.isInput && e5.options.showCursor, e5.cursorChar = e5.options.cursorChar, e5.cursorBlinking = true, e5.elContent = e5.attr ? e5.el.getAttribute(e5.attr) : e5.el.textContent, e5.contentType = e5.options.contentType, e5.typeSpeed = e5.options.typeSpeed, e5.startDelay = e5.options.startDelay, e5.backSpeed = e5.options.backSpeed, e5.smartBackspace = e5.options.smartBackspace, e5.backDelay = e5.options.backDelay, e5.fadeOut = e5.options.fadeOut, e5.fadeOutClass = e5.options.fadeOutClass, e5.fadeOutDelay = e5.options.fadeOutDelay, e5.isPaused = false, e5.strings = e5.options.strings.map(function(e6) {
                  ...
                  if (s2) for (var i2 = 0; i2 < s2; i2 += 1) {
                    var u2 = o2[i2];
                    e5.strings.push(u2.innerHTML.trim());
                  }
                }
                for (var i2 in e5.strPos = 0, e5.arrayPos = 0, e5.stopNum = 0, e5.loop = e5.options.loop, e5.loopCount = e5.options.loopCount, e5.curLoop = 0, e5.shuffle = e5.options.shuffle, e5.sequence = [], e5.pause = { status: false, typewrite: true, curString: "", curStrPos: 0 }, e5.typingComplete = false, e5.strings) e5.sequence[i2] = i2;
            ...
            var r2 = function() {
              ...
              return n2(e4, [{ key: "typeHtmlChars", value: function(e5, t3, n3) {
                if ("html" !== n3.contentType) return t3;
        ...
        function l(e3, t2) {
          ...
          var n2, r2, o2 = function(e4, t3) {
            ...
            for (r3 = 0; r3 < s3.length; r3++) n3 = s3[r3], t3.indexOf(n3) >= 0 || (o3[n3] = e4[n3]);
            return o3;
          }(e3, t2);
          if (Object.getOwnPropertySymbols) {
            var s2 = Object.getOwnPropertySymbols(e3);
            for (r2 = 0; r2 < s2.length; r2++) n2 = s2[r2], t2.indexOf(n2) >= 0 || Object.prototype.propertyIsEnumerable.call(e3, n2) && (o2[n2] = e3[n2]);
          }
          return o2;
        }
        function f(e3, t2) {
        ...
        var h = function(e3) {
          function t2() {
            ...
            for (var l2 = arguments.length, f2 = new Array(l2), d2 = 0; d2 < l2; d2++) f2[d2] = arguments[d2];
        ...
        (function() {
          ...
          var v = function(e4) {
            for (var t2 = arguments.length, n3 = Array(t2 > 1 ? t2 - 1 : 0), r2 = 1; r2 < t2; r2++) n3[r2 - 1] = arguments[r2];
            ...
            if (void 0 === t2) throw new Error("`lowPriorityWarning(condition, format, ...args)` requires a warning message argument");
            if (!e4) {
              for (var n3 = arguments.length, r2 = Array(n3 > 2 ? n3 - 2 : 0), o2 = 2; o2 < n3; o2++) r2[o2 - 2] = arguments[o2];
        ...
        u = function(e3) {
          ...
          var f = "<<anonymous>>", p = { array: m("array"), bool: m("boolean"), func: m("function"), number: m("number"), object: m("object"), string: m("string"), symbol: m("symbol"), any: h(c), arrayOf: function(e4) {
            return h(function(t3, n3, r2, o2, i2) {
              if ("function" != typeof e4) return new d("Property `" + i2 + "` of component `" + r2 + "` has invalid PropType notation inside arrayOf.");
              var a2 = t3[n3];
              if (!Array.isArray(a2)) return new d("Invalid " + o2 + " `" + i2 + "` of type `" + v(a2) + "` supplied to `" + r2 + "`, expected an array.");
            ...
            return h(function(t3, n3, r2, o2, s2) {
              if (!(t3[n3] instanceof e4)) {
                ...
                return new d("Invalid " + o2 + " `" + s2 + "` of type `" + function(e5) {
                  if (!e5.constructor || !e5.constructor.name) return f;
            ...
            return h(function(t3, n3, r2, o2, i2) {
              if ("function" != typeof e4) return new d("Property `" + i2 + "` of component `" + r2 + "` has invalid PropType notation inside objectOf.");
              var u2 = t3[n3], c2 = v(u2);
              if ("object" !== c2) return new d("Invalid " + o2 + " `" + i2 + "` of type `" + c2 + "` supplied to `" + r2 + "`, expected an object.");
              for (var l2 in u2) if (a(u2, l2)) {
                var f2 = e4(u2, l2, r2, o2, i2 + "." + l2, s);
                if (f2 instanceof Error) return f2;
              }
              return null;
            });
          }, oneOf: function(e4) {
            if (!Array.isArray(e4)) return arguments.length > 1 ? u("Invalid arguments supplied to oneOf, expected an array, got " + arguments.length + " arguments. A common mistake is to write oneOf(x, y, z) instead of oneOf([x, y, z]).") : u("Invalid argument supplied to oneOf, expected an array."), c;
            return h(function(t3, n3, r2, o2, s2) {
              for (var i2 = t3[n3], a2 = 0; a2 < e4.length; a2++) if (y(i2, e4[a2])) return null;
            ...
            if (!Array.isArray(e4)) return u("Invalid argument supplied to oneOfType, expected an instance of array."), c;
            for (var t3 = 0; t3 < e4.length; t3++) {
              var n3 = e4[t3];
              if ("function" != typeof n3) return u("Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + S(n3) + " at index " + t3 + "."), c;
            }
            return h(function(t4, n4, r2, o2, i2) {
              for (var a2 = 0; a2 < e4.length; a2++) {
                if (null == (0, e4[a2])(t4, n4, r2, o2, i2, s)) return null;
              }
            ...
            return h(function(t3, n3, r2, o2, i2) {
              ...
              if ("object" !== u2) return new d("Invalid " + o2 + " `" + i2 + "` of type `" + u2 + "` supplied to `" + r2 + "`, expected `object`.");
              for (var c2 in e4) {
                var l2 = e4[c2];
                if (l2) {
            ...
            return h(function(t3, n3, r2, i2, a2) {
              var u2 = t3[n3], c2 = v(u2);
              if ("object" !== c2) return new d("Invalid " + i2 + " `" + a2 + "` of type `" + c2 + "` supplied to `" + r2 + "`, expected `object`.");
              var l2 = o({}, t3[n3], e4);
              for (var f2 in l2) {
                var p2 = e4[f2];
                if (!p2) return new d("Invalid " + i2 + " `" + a2 + "` key `" + f2 + "` supplied to `" + r2 + "`.\nBad object: " + JSON.stringify(t3[n3], null, "  ") + "\nValid keys: " + JSON.stringify(Object.keys(e4), null, "  "));
          ...
          function b(t3) {
            switch (typeof t3) {
              ...
              case "boolean":
                return !t3;
              case "object":
                if (Array.isArray(t3)) return t3.every(b);
                if (null === t3 || e3(t3)) return true;
                var r2 = function(e4) {
                ...
                if (r2 !== t3.entries) {
                  for (; !(o2 = s2.next()).done; ) if (!b(o2.value)) return false;
                } else for (; !(o2 = s2.next()).done; ) {
                  var i2 = o2.value;
                  if (i2 && !b(i2[1])) return false;
                }
                return true;
              default:
                return false;
        ...
        e2.exports = function() {
          ...
          for (var n2, a, u = i(e3), c = 1; c < arguments.length; c++) {
            for (var l in n2 = Object(arguments[c])) o.call(n2, l) && (u[l] = n2[l]);
            if (r) {
              a = r(n2);
              for (var f = 0; f < a.length; f++) s.call(n2, a[f]) && (u[a[f]] = n2[a[f]]);
            }
          }
          return u;
        };
